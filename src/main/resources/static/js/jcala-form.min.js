    ...
    $("#info_update").bind("click",
        ...
        $("#update_pass").bind("click",
            function() {
                ...
                b != c ? alert("Two passwords are not consistent!") : (d = document.forms[1], d.action = "/admin1/pass.action", d.method = "post", document.newPassForm.old_pass.value = md5(a), document.newPassForm.new_pass.value = md5(b), d.submit())
            }),
        $("#login-admin1").bind("click",
            function() {
